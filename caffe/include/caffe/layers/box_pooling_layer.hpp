#ifndef CAFFE_BOX_POOLING_LAYER_HPP_
#define CAFFE_BOX_POOLING_LAYER_HPP_
...
class BOXPoolingLayer : public Layer<Dtype> {
 public:
  explicit BOXPoolingLayer(const LayerParameter& param)
    : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "BOXPooling"; }
